      ...
      <div className="max-w-8xl mx-auto p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          ...
          <div className="bg-white shadow-sm rounded-sm overflow-hidden p-4 flex flex-col">
            ...
            <span className='text-green-500 text-center'>Min 50% Off</span>
          </div>
          ...
          <div className="bg-white shadow-sm rounded-sm overflow-hidden p-4 flex flex-col items-center">
            ...
            <span className='text-green-500 text-center'>Min 70% Off</span>
          </div>
          ...
          <div className="bg-white shadow-sm rounded-sm overflow-hidden p-4 flex flex-col items-center">
            ...
            <span className='text-green-500 text-center'>Min 40% Off</span>
          </div>
          ...
          <div className="bg-white shadow-sm rounded-sm overflow-hidden p-4 flex flex-col items-center">
            ...
            <span className='text-green-500 text-center'>Min 60% Off</span>
          </div>
        </div>
      </div>
      <Footer/>
